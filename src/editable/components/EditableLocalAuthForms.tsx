...
const inputClass = 'h-14 rounded-[1.35rem] border border-[var(--editable-border)] bg-white px-4 text-base font-semibold text-[var(--slot4-page-text)] outline-none transition placeholder:text-[var(--slot4-page-text)]/35 focus:border-[var(--slot4-accent-fill)] focus:shadow-[0_0_0_4px_rgba(129,166,198,0.15)]'
const buttonClass = 'inline-flex h-14 items-center justify-center rounded-full bg-[var(--slot4-accent-fill)] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-[0_16px_34px_rgba(11,101,216,0.2)] transition hover:-translate-y-0.5 disabled:opacity-60'
